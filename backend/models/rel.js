...
const BoardExportHistory = require('./Reporta_Cotia_Tables/BoardExportHistory')
...
module.exports = {
    ...
    Role, Permission, UserRole, RolePermission, UserRoleHistory, BoardExportHistory, ...analytics
}
